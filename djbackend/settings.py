...
AGRO_WEATHER_API_KEY=config('AGRO_WEATHER_API_KEY')
...
JAZZMIN_SETTINGS = {
    "site_title": "Quantum Ripple Admin",
    "site_header": "Quantum Ripple Admin Portal",
    ...
    "icons": {
        "core.Farmer": "fas fa-tractor",
        "core.ChatMessage": "fa-solid fa-message",  # FontAwesome icon
    },
    ...
    "usermenu_links": [
        {"name": "Support", "url": "https://quantumripple.co.ke/", "new_window": True},
    ],
